...
int main(int argc, char *argv[]) {
  ...
  loop_schedule("sched1.csv", "teams.csv", "teams_2026_rankings.csv", 1, true);
  loop_schedule("sched2.csv", "teams_2026_rankings.csv",
                "teams_2026_rankings.csv", 1, true);
  loop_schedule("sched3.csv", "teams_2026_rankings.csv",
                "teams_2026_rankings.csv", 1, false);
